                    ...
                    <div class="container" style="background-color: #ffffff;">
                        <div class="row">
                            <div class="col-lg-3 col-md-6">
                                <div class="card shadow-lg p-3 mb-5 rounded-0">
                                    <img src="images/3x2.jpg" class="card-img-top" alt="..." />
                                </div>
                            </div>
                            ...
                            <div class="col-lg-9 col-md-6">
                                ...
                                <p class="font-medium mb-1 text-wrap">
                        ...
                        <p class="font-medium mb-1 text-wrap">
                            ...
                            culpa qui officia deserunt mollit anim id est laborum. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis
                            nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat
                            cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                        ...
                        <!--  <div class="container-fluid w-100 card-block rounded ">-->
                        <div
                            class="container-fluid site-blocks-cover overlay border-3 border-danger border-right-0 border-top-0 border-left-0"
                        ...
                        <div class="row pt-5 mt-5 text-center">
                            <div class="col-md-12">
                                <p>
                                    ...
                                    All rights reserved | <a href="https://colorlib.com" target="_blank" style="color: red;">तुलसी चहा</a>
                                </p>
                            </div>
                        </div>
                    </div>
